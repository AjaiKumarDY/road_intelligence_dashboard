    ...
    <div className="bg-card rounded-lg border border-border h-full flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={() => setMapView('road-detection')}
            className={`px-3 py-1 text-sm rounded-md transition-colors duration-200 ${
              mapView === 'road-detection' ?'bg-primary text-primary-foreground' :'bg-surface text-muted-foreground hover:text-foreground'
            }`}
          >
      ...
      {/* Conditional Content Based on Map View */}
      {mapView === 'road-detection' ? (
